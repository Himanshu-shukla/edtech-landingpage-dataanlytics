          ...
          <div className="flex flex-col gap-16 md:gap-20">
            {benefitsData.map((benefit, index) => (
              <motion.div
                ...
                // FIX 1: Increased pl-8 to pl-16 (64px) to clear the w-12 (48px) icon
                className="relative group pl-16 md:pl-20"
              >
                {/* Step Circle */}
                {/* Note: Kept top-0, but you might want top-1 to center it with text better */}
                ...
                {/* FIX 2: Added flex-wrap and items-start for better safety on very small screens */}
                <h3 className="text-2xl md:text-3xl font-black text-neutral-900 mb-4 mt-0 md:mt-6 flex flex-col sm:flex-row sm:items-center items-start gap-2 sm:gap-3">
                  <span className="text-emerald-700 font-black text-xs md:text-sm bg-emerald-50 px-2 py-1 rounded-md border border-emerald-100 uppercase tracking-tighter shadow-sm">
                    Phase 0{benefit.id}
                  </span>
